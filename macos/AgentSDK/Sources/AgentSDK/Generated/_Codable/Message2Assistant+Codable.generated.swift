...
extension Message2Assistant {
    public init(json: Any) throws {
        let r = try JSONReader(json, context: "Message2Assistant")
        self._raw = r.dict
        ...
        self.isApiErrorMessage = r.bool("is_api_error_message", alt: "isApiErrorMessage")
        self.isSidechain = r.bool("is_sidechain", alt: "isSidechain")
        self.line = r.int("line")
...
extension Message2Assistant {
    public func toTypedJSON() -> Any {
        ...
        if let v = isApiErrorMessage { d["is_api_error_message"] = v }
        if let v = isSidechain { d["is_sidechain"] = v }
        if let v = line { d["line"] = v }
