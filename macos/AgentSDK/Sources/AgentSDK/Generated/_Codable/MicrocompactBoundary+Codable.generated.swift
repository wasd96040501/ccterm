...
extension MicrocompactBoundary {
    public init(json: Any) throws {
        let r = try JSONReader(json, context: "MicrocompactBoundary")
        self._raw = r.dict
        ...
        self.microcompactMetadata = r.decodeIfPresent("microcompact_metadata", alt: "microcompactMetadata")
...
extension MicrocompactBoundary {
    public func toTypedJSON() -> Any {
        ...
        if let v = microcompactMetadata { d["microcompact_metadata"] = v.toTypedJSON() }
