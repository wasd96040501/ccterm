...
- **Running-state rendering** — `SessionHandle2.isRunning` is `@Observable`. SwiftUI tracks it automatically: `LoadingPillView2` fades in/out, `InputBarView2` swaps send ↔ stop.
