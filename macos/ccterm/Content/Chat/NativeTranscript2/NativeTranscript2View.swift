...
private struct Transcript2NSViewBridge: NSViewRepresentable {
    ...
    static func dismantleNSView(
        ...
        // Tear down the coordinator's notification observers. The
        // coordinator's scroll mode is already up to date — every user
        // scroll between the last mount and this dismantle was captured
        // continuously by the clip-bounds observer the coordinator
        // installs in `tableFrameDidChange`. Nothing to snapshot here.
        coordinator.willDismantleView()
